    ...
    <div>
      <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',marginBottom:'18px',flexWrap:'wrap',gap:'12px'}}>
        <div>
          ...
          <p style={{color:'#6b7280',fontSize:'13px',margin:'4px 0 0'}}>{reqs.length} total · {reqs.filter(r=>r.status==='pending_admin_post').length} awaiting your action</p>
        </div>
      ...
      <div style={{display:'flex',gap:'8px',marginBottom:'16px',flexWrap:'wrap'}}>
        {[['all','All'],['pending_user','Waiting on signer'],['pending_admin_post','Awaiting admin'],['complete','Complete']].map(([k,label])=>(
